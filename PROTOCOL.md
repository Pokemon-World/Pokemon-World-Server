...
Pokémon World's protocol is relatively simple.

Pokémon World is implemented in SockJS. SockJS is a compatibility
layer over raw WebSocket, so you can actually connect to Pokémon
World directly using WebSocket:

    ws://sim.psim.online:8000/server/websocket
      or
    wss://sim.psim.online/server/websocket
...
- Quinella and TalkTakesTime's chat bot (Node.js) -
    https://github.com/TalkTakesTime/Pokemon-World-Bot
- the official client (HTML5 + JavaScript) -
    https://client-not-provided
...
> `http://main.pokemon-world.online/action.php?act=upkeep&challstr=CHALLSTR`
>
> Otherwise, you'll need to make an HTTP POST request to `http://main.pokemon-world.online/action.php`
