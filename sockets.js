...
if (cluster.isMaster) {
	...
	// redirects yourserver:8001 to yourserver-8001.psim.online
	...
	let server = sockjs.createServer({
		sockjs_url: "//main.pokemon-world.online/js/lib/sockjs-1.1.1-nwjsfix.min.js",
	...
	console.log('Your server is up at http://' + (Config.bindaddress === '0.0.0.0' ? 'localhost' : Config.bindaddress) + ':' + Config.port);
